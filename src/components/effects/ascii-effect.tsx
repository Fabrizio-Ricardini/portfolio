...
class AsciiEffectImpl extends Effect {
  ...
  private _colorMode: boolean;
  private _asciiStyle: number;
  ...
  update(_renderer: any, _inputBuffer: any, deltaTime: number) {
    ...
    this.uniforms.get("invert")!.value = this._invert
    this.uniforms.get("colorMode")!.value = this._colorMode
    this.uniforms.get("asciiStyle")!.value = this._asciiStyle
    this.uniforms.get("resolution")!.value = this._resolution
    this.uniforms.get("mousePos")!.value = this._mousePos
  }
}
...
export const AsciiEffect = forwardRef<any, AsciiEffectProps>((props, ref) => {
  ...
  // We do NOT update global variables here anymore, state is encapsulated in the effect instance
